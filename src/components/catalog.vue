...
<script setup lang="ts">
  ...
  const cards = ref([
    { id: 1, images: ['/src/images/basket1.webp', '/src/images/basket2.webp', '/src/images/basket3.webp'], name: 'Корзина для игрушек', price: '1200', link: '', category: 'Корзина для игрушек' },
    ...
    { id: 7, images: ['/src/images/carpet-white1.webp', '/src/images/carpet-white2.webp', '/src/images/carpet-white3.webp'], name: 'Коврик детский', price: '3040', link: '', category: 'Коврик детский' },
