...
<script setup lang="ts">
  ...
  const cards = ref([
    ...
    { id: 2, images: ['/funamo/images/noimage.webp'], name: 'Корзина для хранения', price: '3040', link: '', category: 'Корзина для хранения' },
    { id: 3, images: ['/funamo/images/noimage.webp'], name: 'Защитная накладка для дома', price: '12100', link: '', category: 'Защитная накладка для дома' },
    { id: 4, images: ['/funamo/images/noimage.webp'], name: 'Набор для праздника', price: '3040', link: '', category: 'Набор для праздника' },
    { id: 5, images: ['/funamo/images/noimage.webp'], name: 'Игровая палатка', price: '1200', link: '', category: 'Игровая палатка' },
    { id: 6, images: ['/funamo/images/noimage.webp'], name: 'Нагрудник', price: '3040', link: '', category: 'Нагрудник' },
    ...
    { id: 8, images: ['/funamo/images/noimage.webp'], name: 'Корзина для игрушек розовая', price: '1500', link: '', category: 'Корзина для игрушек' },
    { id: 9, images: ['/funamo/images/noimage.webp'], name: 'Игровая палатка с звездами', price: '2500', link: '', category: 'Игровая палатка' },
  ])
