...
<script setup lang="ts">
  ...
  const cards = ref([
    { id: 1, images: ['/public/images/basket1.webp', '/public/images/basket2.webp', '/public/images/basket3.webp'], name: 'Корзина для игрушек', price: '1200', link: '', category: 'Корзина для игрушек' },
    ...
    { id: 7, images: ['/public/images/carpet-white1.webp', '/public/images/carpet-white2.webp', '/public/images/carpet-white3.webp'], name: 'Коврик детский', price: '3040', link: '', category: 'Коврик детский' },
